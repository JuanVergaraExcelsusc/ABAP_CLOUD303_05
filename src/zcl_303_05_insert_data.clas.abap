CLASS zcl_303_05_insert_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_303_05_insert_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
  out->write('Hello from the console').

  data: lt_acc_categ   type table of ztb_l_acc_cate05,
          lt_catego    type table of ztb_l_categ05,
          lt_clientes  type table of ztb_l_clientes05,
          lt_clnts_lib type table of ztb_l_clnt_lib05,
          lt_libros    type table of ztb_l_libros05.
...
******** TABLA1 ********
    ...
    delete from ztb_l_acc_cate05.
    insert ztb_l_acc_cate05 from table @lt_acc_categ.
...
******** TABLA2 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_l_categ05.
    insert ztb_l_categ05 from table @lt_catego.
...
******** TABLA3 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_l_clientes05.
    insert ztb_l_clientes05 from table @lt_clientes.
...
******** TABLA4
    ...
    "Delete possible entries; insert new entries
    delete from ztb_l_clnt_lib05.
    insert ztb_l_clnt_lib05 from table @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_l_libros05.
    insert ztb_l_libros05 from table @lt_libros.
