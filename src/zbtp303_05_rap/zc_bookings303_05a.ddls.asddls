...
define view entity ZC_BOOKINGS303_05A
  as projection on zr_bookings303_05a
{
  key BookingUUID,
      ...
      /* Associations */
      _BookingStatus,
      _BookingSupplement : redirected to composition child ZC_BOOKSUPPL303_05_A,
      _Carrier,
      _Connection,
      _Customer,
      _Travel            : redirected to parent ZC_TRAVEL303_05_A
}
